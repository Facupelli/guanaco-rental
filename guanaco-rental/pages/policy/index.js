  ...
  return (
    <div>
      ...
      <main className={s.main}>
        <div>
          ...
          <p>Last updated: September 05, 2022 This</p>
          ...
          <p>
            ...
            refers to Guanaco Rental, Las Palmas Norte 135. * Cookies are small
            ...
            on that website among its many uses. * Country refers to: Argentina
            * Device means any device that can access the Service such as a
            ...
            used. * Usage Data refers to data collected automatically, either
            generated by the use of the Service or from the Service
            infrastructure itself (for example, the duration of a page visit). *
            Website refers to Guanaco Rental, accessible from{" "}
            <a href="https://www.guanacorental.shop/">link</a>* You means the
          ...
          <p>
            ...
            Data may include information such as Your Device&aposs Internet
    ...
    flash.html#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_objects_"
            ...
            * Web Beacons. Certain sections of our Service and our emails may
            ...
            system and server integrity). Cookies can be &quotPersistent&quot or
            &quotSession&quot Cookies. Persistent Cookies remain on Your
            ...
            template/#Use_Of_Cookies_And_Tracking) article. We use both Session
          ...
          <p>
            ...
            our Service. * To manage Your Account: to manage Your registration
            ...
            necessary or reasonable for their implementation. * To provide You
            ...
            not to receive such information. * To manage Your requests: To
            ...
            You. * For business transfers: We may share or transfer Your
            ...
            or a portion of Our business to another company. * With Affiliates:
            ...
            and may be publicly distributed outside. * With Your consent : We
          ...
          <p>
            ...
            with a legal obligation * Protect and defend the rights or property
            of the Company * Prevent or investigate possible wrongdoing in
            connection with the Service * Protect the personal safety of Users
          ...
          <p>
            ...
            us: * By email: hello@guanacorental.com
          </p>
        </div>
      </main>
    </div>
